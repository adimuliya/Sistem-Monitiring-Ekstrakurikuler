...
<head>
    ...
    <title>Sistem Monitoring Ekstrakurikuler</title>
    ...
    <!-- Skrip khusus untuk template ini -->
    <script src="js/sb-admin-2.min.js"></script>
    <!-- JavaScript untuk menampilkan pesan kesalahan atau keberhasilan -->
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-1">
                                <h6 class="m-0 font-weight-bold text-primary">Data Akun Kesiswaan</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody style="background-color: #EAF5FF;">
                                        <?php
                                        // Query untuk mendapatkan data pengguna dengan role kesiswaan
                                        $usersQuery = mysqli_query($conn, "SELECT username, role FROM users WHERE role = 'kesiswaan'");
                ...
                <?php
                // Loop untuk menampilkan modal edit untuk setiap akun
                $nomor = 1;
                $usersQuery = mysqli_query($conn, "SELECT username, role FROM users WHERE role = 'kesiswaan'");
                while ($user = mysqli_fetch_assoc($usersQuery)) {
                ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" action="proses_edit_akun.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="new_username" name="new_username" placeholder="Username Baru" value="<?php echo $user['username']; ?>">
                                        </div>
                ...
                <div class="modal fade" id="tambahEkstraModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="proses_tambah_akun.php">
                                    <div class="form-group">
                ...
                <!-- Script JavaScript untuk menangani hapus akun -->
                <script>
                    ...
                    $('#hapusAkunBtn').click(function() {
                        ...
                        window.location.href = "proses_hapus_akun.php?username=" + username;
                    });
                </script>
                ...
                <!-- Script JavaScript di bagian akhir file -->
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
                <script>
                    function hapusAkunModal(nomor, username) {
                        // Tampilkan modal konfirmasi hapus dengan ID yang sesuai
