...
$totalEkstraIkutQuery = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tb_ekstra_yang_diikuti WHERE id_user = '$idSiswa'");
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 ">
                        <h1 class="h3 mb-0 text-gray-800">Ekstra Yang diikuti</h1>
                    </div>
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-12">
                                            <div class="card shadow">
                                                <div class="card-body">
                                                    <strong class="card-title">NIS:</strong> <?php echo $_SESSION['nis']; ?><br>
                                                    <p class="card-text">
                                                        <strong>Nama Siswa:</strong> <?php echo $_SESSION['nama_siswa']; ?><br>
                                                        <strong>Kelas:</strong> <?php echo $_SESSION['kelas']; ?><br>
                    ...
                    <!-- Ekstra Yang Diikuti Card -->
                    <div class="card mb-4">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h5 class="mb-0">Ekstra Yang Diikuti</h5>
                            </div>
                            <div class="card shadow">
                                <div class="card-body">
                                    <?php if ($totalEkstraIkut > 0) : ?>
                                        <div class="row">
                                            <?php
                                            // Query untuk mendapatkan data ekstra yang diikuti oleh siswa
                                            $ekstraQuery = mysqli_query($conn, "SELECT tb_ekstrakurikuler.nama_ekstra, tb_ekstrakurikuler.jadwal_hari, tb_ekstrakurikuler.jadwal_jam FROM tb_ekstra_yang_diikuti
                        JOIN tb_ekstrakurikuler ON tb_ekstrakurikuler.id_ekstra = tb_ekstra_yang_diikuti.id_ekstra
                        WHERE tb_ekstra_yang_diikuti.id_user = '$idSiswa'");

                                            while ($ekstra = mysqli_fetch_assoc($ekstraQuery)) :
                                            ?>
                                                <div class="col-md-4 mb-3">
                                                    <div class="card shadow">
                                                        <div class="card-body">
                                                            <h6 class="card-title text-primary"><?php echo $ekstra['nama_ekstra']; ?></h6>
                                                            <p class="card-text">
                                                                <strong>Hari:</strong> <?php echo $ekstra['jadwal_hari']; ?><br>
                                                                <strong>Jam:</strong> <?php echo $ekstra['jadwal_jam']; ?><br>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <?php else : ?>
                                        <p class="card-text">
                                            Anda belum mengikuti ekstrakurikuler. Segera daftar sekarang untuk merasakan pengalaman seru bersama ekstrakurikuler!
                                        </p>
                                        <a href="form_pendaftaran.php" class="btn btn-danger">Daftar Sekarang</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
