                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="card <?php echo $cardColorClass; ?> shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Total Ekstrakurikuler</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalEkstra; ?></div>
                                            </div>
                                            <div class="col-auto">
                                ...
                                <div class="card <?php echo $cardColorClass; ?> shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Total Ekstra Yang Diikuti</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalEkstraIkut; ?></div>
                                            </div>
                                            <div class="col-auto">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="card shadow h-100 py-2">
                                        <div class="card-header py-3">
                                            <h6 class="card-title text-primary" style="font-weight: bold;"><?php echo $ekstrakurikuler['nama_ekstra']; ?></h6>

                                        </div>
                                        <div class="card-body">
                                            <p class="card-text">
                                                <strong>Pembimbing:</strong> <?php echo $ekstrakurikuler['nama_pembimbing']; ?><br>
                                                <strong>Hari:</strong> <?php echo $ekstrakurikuler['jadwal_hari']; ?><br>
                                                <strong>Jam:</strong> <?php echo $ekstrakurikuler['jadwal_jam']; ?><br>
                                            </p>
                                            <!-- Tombol Pendaftaran -->
                                            <a href="form_pendaftaran.php?id=<?php echo $ekstrakurikuler['id_ekstra']; ?>" class="btn btn-primary">Daftar</a>
